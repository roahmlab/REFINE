...
<p align="center">
  <img height="300" src="../Image/slip_ratio.png"/>
   <figcaption>System Identification on longitudinal tire force. A linear model is fit to data collected within the linear regime $[-0.45,0.45]$ of slip ratio.</figcaption>
</p>
 </figure>
