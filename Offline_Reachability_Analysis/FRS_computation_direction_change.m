...
for t0_idx = 1:length(t0_arr)
    ...
    for vx0 = vx0_vec(1:end)
        ...
        del_y_arr = linspace(0,Ay_vec(vx0_idx),2*num_Ay+1);
        ...
        for del_y_idx = 1:length(del_y_arr)
            ...
            options.x0(7) = vx0;
            options.x0(11) = vx0; % recall p_vx = vx0 by definition of P
            options.x0(10) = t0; 
            options.x0(12) = p_y;
            options.x0(14) = 0; 
            ...
            delvx0 = zeros(dim,1); delvx0(4) = vx0_gen; delvx0(7) = vx0_gen; delvx0(11) = vx0_gen; % recall p_vx = vx0 by definition of P
            ...
            options.R0 = zonotope( [options.x0, delx0,dely0,delh0,delvx0, delp_y,delvy0,delr0,delFy,delFx]);
            ...
            brake_time = (vx0 - vx_really_slow )/amax;
            ...
            save("./FRSdata/dir_change_t0="+num2str(t0)+"_vx0="+num2str(vx0)+"_p_y="+num2str(del_y_idx)+","+num2str(p_y)+".mat",'vehRS_save','brake_idx1','brake_idx2');
        end
    end
end