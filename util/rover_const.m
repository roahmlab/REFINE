...
Ku = 4;
Kh = 5;
kappaP_vx = 1.2; % kappa_1,vx
kappaI_vx = 0.8; % kappa_2,vx
phiP_vx = 1.2;   % phi_1,vx
phiI_vx = 0.8;   % phi_2,vx
...
vx_really_slow = 0.5; % u^{cri}: critical speed that decides the guard of vehicle's hybrid system
