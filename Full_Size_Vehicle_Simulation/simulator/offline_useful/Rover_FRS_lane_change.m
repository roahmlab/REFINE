    ...
    for u0 = u0_vec % set range of Ay or del_y allowed
        ...
        for del_y_idx = 1:length(del_y_arr)
            ...
            for i = 1:length(vehBrk)
                ...
                temp = zeros(dim,1); temp(end) = tpk-t0;
            ...
            if previous_error_flag
                save("./data/lane_change/various_initial_condition/lane_change_t0="+num2str(t0)+"_u="+num2str(u0)+"_Ay="+num2str(del_y_idx)+","+num2str(del_y)+".mat",'vehRS_save');
            else
                save("./data/lane_change/zero_initial_condition/lane_change_t0="+num2str(t0)+"_u="+num2str(u0)+"_Ay="+num2str(del_y_idx)+","+num2str(del_y)+".mat",'vehRS_save');
            end
        end
    end
end