        ...
        function placeCars(W)
            ...
            for i = 2:W.num_cars
                ...
                while laneOverlap
                    ...
                    if W.JL_case_construction 
                        if is_static_obs
                            MAX_DIST =  abs(1000) - W.car_safe_dist; 
                        else
                            MAX_DIST = W.SIM_MAX_DISTANCE;
                        end
                        xPos = MAX_DIST * rand  + 80;% start at least 30
                    else
                        MAX_DIST =  abs(1000) - W.car_safe_dist;
                        xPos = MAX_DIST * rand  + 80;% start at least 50
                    end
                    ...
                    if ~laneOverlap % assign car to new slot
                        ...
                        W.envCars(i,4) = W.car_max_spd - rand*(W.car_max_spd-W.car_min_spd)/3; % JL: envCars(:, 4:6) is not used
