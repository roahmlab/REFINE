...
function output = car_highway_endpoint_gpopsADiGatorGrd(input)
global ADiGator_car_highway_endpoint_gpopsADiGatorGrd
if isempty(ADiGator_car_highway_endpoint_gpopsADiGatorGrd); ADiGator_LoadData(); end
Gator1Data = ADiGator_car_highway_endpoint_gpopsADiGatorGrd.car_highway_endpoint_gpopsADiGatorGrd.Gator1Data;
...
global ADiGator_car_highway_endpoint_gpopsADiGatorGrd
ADiGator_car_highway_endpoint_gpopsADiGatorGrd = load('car_highway_endpoint_gpopsADiGatorGrd.mat');
return
end