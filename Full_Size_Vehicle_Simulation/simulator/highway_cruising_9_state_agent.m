classdef highway_cruising_9_state_agent < RTD_agent_2D
    ...
    properties
        ...
        desired_initial_condition = [0; 0; 0; 1; 0; 0; 1; 0; 0];
    ...
    methods
        %% constructor
        function A = highway_cruising_9_state_agent(varargin)
        ...
        function [delta, w_cmd, r_err, h_err] = FL_LLC(A,t,z,T,U,Z)
            h = z(3);
            u = z(4);
            v = z(5);
            r = z(6);
            ...
            Fywr = -A.Car1*tanh(A.Car2*alphar);% +5;% here 8 is the uncertainty
        ...
        function [dzdt, Fxwf, Fywf, Fywr ,delta ,w_cmd, v, r, Fxwr]= dynamics(A,t,z,T,U,Z) % extra output used
            ...
            [delta, w_cmd, cur_r_err, cur_h_err] = A.FL_LLC(t,z,T,U,Z);
            %             w_cmd
            %             [w_cmd, u]
