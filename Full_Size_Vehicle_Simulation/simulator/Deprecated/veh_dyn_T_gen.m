...
Ay = 0; av0 = 0; au0 = 0; syms v0 r0%v0=0; r0=0;
...
syms x y tdummy udummy av0 au0 Ay
...
Au = u0; av0 = 0; au0 = 0; syms v0 r0% v0=0; r0=0;
...
dx = [  u .* cos( psi ) - v .* sin( psi ); u .* sin( psi ) + v .* cos( psi );  r; dudt; dvdt; drdt; zeros(8,1); 1 ];
end
